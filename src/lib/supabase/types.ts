...
// Table: accounts_payable
//   Policy "tenant_isolation_ap_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_ap_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (created_by = auth.uid())
//   Policy "tenant_isolation_ap_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_ap_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//     WITH CHECK: (created_by = auth.uid())
// Table: accounts_receivable
//   Policy "tenant_isolation_ar_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_ar_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (created_by = auth.uid())
//   Policy "tenant_isolation_ar_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_ar_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//     WITH CHECK: (created_by = auth.uid())
// Table: activities
//   Policy "tenant_isolation_act_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_act_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (created_by = auth.uid())
//   Policy "tenant_isolation_act_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_act_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//     WITH CHECK: (created_by = auth.uid())
// Table: cashflow_snapshots
...
//     WITH CHECK: (get_my_role() = ANY (ARRAY['admin'::app_role, 'financeiro'::app_role]))
// Table: financial_transactions
//   Policy "tenant_isolation_ft_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_ft_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (created_by = auth.uid())
//   Policy "tenant_isolation_ft_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//   Policy "tenant_isolation_ft_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (created_by = auth.uid())
//     WITH CHECK: (created_by = auth.uid())
// Table: profiles
//   Policy "Allow read for all authenticated" (SELECT, PERMISSIVE) roles={authenticated}
...
//   trg_set_created_by_ap: CREATE TRIGGER trg_set_created_by_ap BEFORE INSERT ON public.accounts_payable FOR EACH ROW EXECUTE FUNCTION set_created_by_uid()
// Table: accounts_receivable
...
//   trg_set_created_by_ar: CREATE TRIGGER trg_set_created_by_ar BEFORE INSERT ON public.accounts_receivable FOR EACH ROW EXECUTE FUNCTION set_created_by_uid()
// Table: activities
...
//   trg_set_created_by_act: CREATE TRIGGER trg_set_created_by_act BEFORE INSERT ON public.activities FOR EACH ROW EXECUTE FUNCTION set_created_by_uid()
// Table: cashflow_snapshots
...
//   trg_set_created_by_ft: CREATE TRIGGER trg_set_created_by_ft BEFORE INSERT ON public.financial_transactions FOR EACH ROW EXECUTE FUNCTION set_created_by_uid()
// Table: profiles
